...
4. Run `sonar-scanner` (if installed/configured).
5. Perform AI security review against OWASP Top 10 (2025).
6. Check Go-specific security issues (JSON injection, goroutine leaks, SQL injection, etc.).
